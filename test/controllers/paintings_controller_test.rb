...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { description: @painting.description, gallery_id: @painting.gallery_id, image: @painting.image, name: @painting.name }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { description: @painting.description, gallery_id: @painting.gallery_id, image: @painting.image, name: @painting.name }
    assert_redirected_to painting_path(assigns(:painting))
  end
